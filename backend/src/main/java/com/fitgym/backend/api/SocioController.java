...
//    public PreferenciasResponse getPreferencias(HttpServletRequest request) {
//        SocioSession session = requireSession(request);
//        Socio socio = socioService.obtenerPorId(session.getId());
//
...
//    public PreferenciasResponse updatePreferencias(
//            @RequestBody PreferenciasUpdateRequest req,
//            HttpServletRequest request
//    ) {
//        SocioSession session = requireSession(request);
//        return socioService.actualizarPreferencias(session.getId(), req);
//    }
//}
...
public class SocioController {
    ...
    // ✅ helper: reuse in all /me endpoints
    ...
    // ✅ Preferencias
    @GetMapping("/me/preferencias")
    public ResponseEntity<PreferenciasResponse> getPreferencias(HttpServletRequest request) {
        SocioSession socioSession = requireSession(request);
        return ResponseEntity.ok(socioService.obtenerPreferencias(socioSession.getId()));
    }

    @PutMapping("/me/preferencias")
    public ResponseEntity<PreferenciasResponse> updatePreferencias(
            @Valid @RequestBody PreferenciasUpdateRequest req,
            HttpServletRequest request
    ) {
        SocioSession socioSession = requireSession(request);
        return ResponseEntity.ok(socioService.actualizarPreferencias(socioSession.getId(), req));
    }
}